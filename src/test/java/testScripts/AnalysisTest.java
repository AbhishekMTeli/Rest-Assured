...
public class AnalysisTest extends BaseTest {
	...
	public void givenValidAuthAndStaffNumber_thenReturn200() {
		Response response = AnalysisEndPoints.analysis(true, null, true, null);
		...
		ApiUtils.validateNotNull(response, "[0].modules[0].lessons[0].progress");
		ApiUtils.validateNotNull(response, "[0].modules[0].lessons[0].timeSpent");
	...
	public void givenInvalidAuthToken_thenReturn401() {
		Response response = AnalysisEndPoints.analysis(true, "invalidToken", true, null);
	...
	public void givenNoAuth_thenReturn401() {
		Response response = AnalysisEndPoints.analysis(false, null, true, null);
		ApiUtils.validateStatusCode(response, 401);
	}
	...
	public void givenExpiredAuthToken_thenReturn401() {
		...
		Response response = AnalysisEndPoints.analysis(true, expiredToken, true, null);
		ApiUtils.validateStatusCode(response, 401);
	}
	...
	public void givenMissingStaffNumber_thenReturn400() {
		Response response = AnalysisEndPoints.analysis(true, null, false, null);
	...
	public void givenInvalidStaffNumber_thenReturn200() {
		Response response = AnalysisEndPoints.analysis(true, null, true, "350445");
		ApiUtils.validateStatusCode(response, 200);
	}

	@Test(description = "Verify API handles very large StaffNumber gracefully")
	public void givenLargeStaffNumber_thenReturn200() {
		Response response = AnalysisEndPoints.analysis(true, null, true, "9999999999");
		ApiUtils.validateStatusCode(response, 200);
	}
