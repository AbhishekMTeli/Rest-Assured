...
public class ExamTime_AnalysisTest extends BaseTest {
	...
	public void givenValidAuthAndStaffNumber_thenReturn200() {
		Response response = AnalysisEndPoints.examTime_Anaysis(true, null, true, null);
		ApiUtils.validateStatusCode(response, 200);
		ApiUtils.validateNotNull(response, "[0].PUB_ASSESSMENT_ID");
		ApiUtils.validateNotNull(response, "[0].TIMEELAPSED");
	...
	public void givenInvalidAuthToken_thenReturn401() {
		Response response = AnalysisEndPoints.examTime_Anaysis(true, "invalidToken", true, null);
	...
	public void givenNoAuth_thenReturn401() {
		Response response = AnalysisEndPoints.examTime_Anaysis(false, null, true, null);
		ApiUtils.validateStatusCode(response, 401);
	}
	...
	public void givenExpiredAuthToken_thenReturn401() {
		...
		Response response = AnalysisEndPoints.examTime_Anaysis(true, expiredToken, true, null);
		ApiUtils.validateStatusCode(response, 401);
	}
	...
	public void givenMissingStaffNumber_thenReturn400() {
		Response response = AnalysisEndPoints.examTime_Anaysis(true, null, false, null);
	...
	public void givenInvalidStaffNumber_thenReturn200() {
		Response response = AnalysisEndPoints.examTime_Anaysis(true, null, true, "350445");
		ApiUtils.validateStatusCode(response, 200);
	}

	@Test(description = "Verify API handles very large StaffNumber gracefully")
	public void givenLargeStaffNumber_thenReturn200() {
		Response response = AnalysisEndPoints.examTime_Anaysis(true, null, true, "9999999999");
		ApiUtils.validateStatusCode(response, 200);
	}
