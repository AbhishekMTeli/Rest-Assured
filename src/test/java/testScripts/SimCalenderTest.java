...
public class SimCalenderTest extends BaseTest{
	...
	public void givenValidAuthAndStaffNumber_thenReturn200() {
		Response response = CalenderEndPoints.simCalender(true, null, true, null);
		ApiUtils.validateStatusCode(response, 200);
		ApiUtils.validateNotNull(response, "[0].schedulingId");
		ApiUtils.validateNotNull(response, "[0].instructorName");
		ApiUtils.validateNotNull(response, "[0].instructorId");
		ApiUtils.validateNotNull(response, "[0].role");
		ApiUtils.validateNotNull(response, "[0].color");
		ApiUtils.validateNotNull(response, "[0].trainingCourseId");
		ApiUtils.validateNotNull(response, "[0].crewScheduleCode");
		ApiUtils.validateNotNull(response, "[0].batchNo");
		ApiUtils.validateNotNull(response, "[0].str_start_date");
		ApiUtils.validateNotNull(response, "[0].str_end_date");
		ApiUtils.validateNotNull(response, "[0].sch_req_startDateTime");
		ApiUtils.validateNotNull(response, "[0].sch_req_endDateTime");
		ApiUtils.validateNotNull(response, "[0].userRole");
		ApiUtils.validateNotNull(response, "[0].devType_desc");
		ApiUtils.validateNotNull(response, "[0].listofTraineeNames");
	}
	...
	public void givenInvalidAuthToken_thenReturn401() {
		Response response = CalenderEndPoints.simCalender(true, "invalidToken", true, null);
	...
	public void givenNoAuth_thenReturn401() {
		Response response = CalenderEndPoints.simCalender(false, null, true, null);
		ApiUtils.validateStatusCode(response, 401);
	}
	...
	public void givenExpiredAuthToken_thenReturn401() {
		...
		Response response = CalenderEndPoints.simCalender(true, expiredToken, true, null);
		ApiUtils.validateStatusCode(response, 401);
	}
	...
	public void givenMissingStaffNumber_thenReturn400() {
		Response response = CalenderEndPoints.simCalender(true, null, false, null);
	...
	public void givenInvalidStaffNumber_thenReturn200() {
		Response response = CalenderEndPoints.simCalender(true, null, true, "350445");
		ApiUtils.validateStatusCode(response, 200);
	}

	@Test(description = "Verify API handles very large StaffNumber gracefully")
	public void givenLargeStaffNumber_thenReturn200() {
		Response response = CalenderEndPoints.simCalender(true, null, true, "9999999999");
		ApiUtils.validateStatusCode(response, 200);
	}
