...
public class AdminGetAllQueriesTest extends BaseTest {
	...
	public void verifyAdminGetAllQueriesAPI_WithValidAuthAndParams_ShouldReturn200AndValidData() {
		Response response = Q_E_F_Endpoints.adminGetAllQueries(true, null);
	...
	public void verifyAdminGetAllQueriesAPI_WithInvalidAuth_ShouldReturn401() {
		Response response = Q_E_F_Endpoints.adminGetAllQueries(true, "ovverride token");
	...
	public void verifyAdminGetAllQueriesAPI_WithoutAuth_ShouldReturn401() {
		Response response = Q_E_F_Endpoints.adminGetAllQueries(false, null);
		ApiUtils.validateStatusCode(response, 401);
	}

	@Test(description = "Verify Admin Get All Queries API response matches the expected JSON schema")
	public void verifyAdminGetAllQueriesAPI_ResponseMatchesJsonSchema() {
		Response response = Q_E_F_Endpoints.adminGetAllQueries(true, null);
	...
	public void verifyAdminGetAllQueriesAPI_WithExpiredToken_ShouldReturn401() {
		...
		Response response = Q_E_F_Endpoints.adminGetAllQueries(true, expiredToken);
		ApiUtils.validateStatusCode(response, 401);
	}
}
