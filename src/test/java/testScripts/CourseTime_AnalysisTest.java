...
public class CourseTime_AnalysisTest extends BaseTest {
	...
	public void givenValidAuthAndStaffNumber_thenReturn200() {
		Response response = AnalysisEndPoints.courseTime_Analysis(true, null, true, null);
		ApiUtils.validateStatusCode(response, 200);
		ApiUtils.validateNotNull(response, "[0].courseId");
		ApiUtils.validateNotNull(response, "[0].courseName");
		ApiUtils.validateNotNull(response, "[0].courseTotalTime");
		ApiUtils.validateNotNull(response, "[0].modules[0].moduleId");
		ApiUtils.validateNotNull(response, "[0].modules[0].moduleName");
		ApiUtils.validateNotNull(response, "[0].modules[0].lessons[0].lessonId");
		ApiUtils.validateNotNull(response, "[0].modules[0].lessons[0].lessonName");
		ApiUtils.validateNotNull(response, "[0].modules[0].lessons[0].lessonTime");
		ApiUtils.validateNotNull(response, "[0].modules[0].lessons[0].lastAccessed");
	}
	...
	public void givenInvalidAuthToken_thenReturn401() {
		Response response = AnalysisEndPoints.courseTime_Analysis(true, "invalidToken", true, null);
	...
	public void givenNoAuth_thenReturn401() {
		Response response = AnalysisEndPoints.courseTime_Analysis(false, null, true, null);
		ApiUtils.validateStatusCode(response, 401);
	}
	...
	public void givenExpiredAuthToken_thenReturn401() {
		...
		Response response = AnalysisEndPoints.courseTime_Analysis(true, expiredToken, true, null);
		ApiUtils.validateStatusCode(response, 401);
	}
	...
	public void givenMissingStaffNumber_thenReturn400() {
		Response response = AnalysisEndPoints.courseTime_Analysis(true, null, false, null);
	...
	public void givenInvalidStaffNumber_thenReturn200() {
		Response response = AnalysisEndPoints.courseTime_Analysis(true, null, true, "350445");
		ApiUtils.validateStatusCode(response, 200);
	}

	@Test(description = "Verify API handles very large StaffNumber gracefully")
	public void givenLargeStaffNumber_thenReturn200() {
		Response response = AnalysisEndPoints.courseTime_Analysis(true, null, true, "9999999999");
		ApiUtils.validateStatusCode(response, 200);
	}
